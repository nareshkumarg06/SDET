...
public class OrderPlacementDBValidation extends BasePage {
	LoginPage loginPage;
	HomePage homePage;
	ChairPage chairPage;
	...
	WebDriver driver;
	Logger log = Logger.getLogger(OrderPlacementDBValidation.class.getName());
	
	public OrderPlacementDBValidation() {
		super();
